...
private:
  ...
  enum {
    ...
    hist1d_residual_u_toPrimariesSecondaries_length1,
    hist1d_residual_u_toPrimariesSecondaries_length2,
    hist1d_residual_u_toPrimariesSecondaries_length3,
    hist1d_residual_u_toPrimariesSecondaries_length4,
    hist1d_residual_u_toPrimariesSecondaries_length5plus,
    ...
    hist1d_residual_v_toPrimariesSecondaries_length1,
    hist1d_residual_v_toPrimariesSecondaries_length2,
    hist1d_residual_v_toPrimariesSecondaries_length3,
    hist1d_residual_v_toPrimariesSecondaries_length4,
    hist1d_residual_v_toPrimariesSecondaries_length5plus,
